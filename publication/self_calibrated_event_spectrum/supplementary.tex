...
\usepackage{placeins}
\usepackage{xcolor}
% Provide lightweight citation defaults so local builds succeed
\providecommand{\cite}[1]{[#1]}
\providecommand{\citet}[1]{\cite{#1}}
\providecommand{\citep}[1]{\cite{#1}}
% When natbib is installed, load it to restore full citation features
