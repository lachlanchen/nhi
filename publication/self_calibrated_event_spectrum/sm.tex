...
Figure~\ref{fig:device_setup} shows the physical configuration of the prototype hyperspectral microscope used throughout the study. A broadband 2835 LED, collimator, and motorised grating--dichroic assembly (bottom left) sweep a dispersed illumination line across the specimen, which is fixed at the centre of the optical breadboard. The grating arm is driven by a NEMA-17 stepper motor using a compact 3D-printed fixture with modular holders for the LED, collimator tube, and grating cap. Above the sample, a vertical $4f$ detection column relays the transmitted light to an event camera and a frame-based hyperspectral sensor through a lateral beam splitter. All illumination mounts, motor couplings, and microscope adapters are 3D-printed (Ultimaker~3S) with snap-fit tolerances, isolating the scanning illumination subsystem from the detection stack and enabling repeatable forward/backward scans without precision optomechanics.
