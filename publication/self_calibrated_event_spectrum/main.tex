...
\begin{figure}[t]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img3a.south east)}, y={(img3a.north west)}]
      \node[font=\bfseries, anchor=north west, fill=none, text=black, inner sep=2pt] at (0.006, 1.000) {(a)};
    \end{scope}
  \end{tikzpicture}\\[1pt]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img3b.south east)}, y={(img3b.north west)}]
      \node[font=\bfseries, anchor=north west, fill=none, text=black, inner sep=2pt] at (0.006, 1.000) {(b)};
    \end{scope}
  \end{tikzpicture}\\[1pt]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img3c.south east)}, y={(img3c.north west)}]
      \node[font=\bfseries, anchor=north west, fill=none, text=black, inner sep=2pt] at (0.006, 1.000) {(c)};
    \end{scope}
  \end{tikzpicture}
