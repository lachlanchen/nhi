...
\begin{figure}[t]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img3c.south east)}, y={(img3c.north west)}]
      \node[font=\bfseries, anchor=north west, fill=white, text=black, inner sep=2pt] at (0.012, 0.988) {(c)};
    \end{scope}
  \end{tikzpicture}
...
\begin{figure*}[t]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img.south east)}, y={(img.north west)}]
      \node[font=\bfseries, anchor=north west, fill=white, text=black, inner sep=2pt] at (0.012, 0.988) {(a)};
      \node[font=\bfseries, anchor=north west, fill=white, text=black, inner sep=2pt] at (0.012, 0.49) {(b)};
    \end{scope}
  \end{tikzpicture}
