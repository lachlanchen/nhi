...
% Use generic Optica journal style; OL-specific style not installed in this env
...
% Optics Letters run-in section headings helper (leave \section intact for refs)
...
\olsection{Multi-window time-warp compensation}
...
\begin{figure}[t]
  \centering
  % Row 1: (a) events with boundaries, (b) single-bin comparison
  \begin{minipage}[t]{0.49\linewidth}
    \begin{tikzpicture}
      ...
      \begin{scope}[x={(img3a.south east)}, y={(img3a.north west)}]
        \node[font=\bfseries, anchor=north west, fill=white, text=black, inner sep=2pt] at (0.012, 0.990) {(a)};
      \end{scope}
    \end{tikzpicture}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.49\linewidth}
    \begin{tikzpicture}
      ...
      \begin{scope}[x={(img3c.south east)}, y={(img3c.north west)}]
        \node[font=\bfseries, anchor=north west, fill=white, text=black, inner sep=2pt] at (0.012, 0.990) {(b)};
      \end{scope}
    \end{tikzpicture}
  \end{minipage}\\[1pt]
  % Row 2: (c) variance vs time (50 ms bins)
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img3b.south east)}, y={(img3b.north west)}]
      \node[font=\bfseries, anchor=north west, fill=white, text=black, inner sep=2pt] at (0.012, 0.990) {(c)};
    \end{scope}
  \end{tikzpicture}
