...
\begin{figure}[t]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img3a.south east)}, y={(img3a.north west)}]
      \node[font=\bfseries, anchor=north west, fill=black!60, text=white, inner sep=2pt, rounded corners=1pt] at (0.012, 0.988) {(a)};
    \end{scope}
  \end{tikzpicture}\\[4pt]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img3b.south east)}, y={(img3b.north west)}]
      \node[font=\bfseries, anchor=north west, fill=black!60, text=white, inner sep=2pt, rounded corners=1pt] at (0.012, 0.988) {(b)};
    \end{scope}
  \end{tikzpicture}\\[4pt]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img3c.south east)}, y={(img3c.north west)}]
      \node[font=\bfseries, anchor=north west, fill=black!60, text=white, inner sep=2pt, rounded corners=1pt] at (0.012, 0.988) {(c)};
    \end{scope}
  \end{tikzpicture}
