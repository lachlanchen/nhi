...
\begin{figure}[t]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(f2a.south east)}, y={(f2a.north west)}]
      % Mask any embedded panel letter and place TeX label
      \node[font=\bfseries, anchor=north west, fill=white, draw=white, inner sep=2pt, rounded corners=0.5pt] at (0.012, 0.988) {(a)};
    \end{scope}
  \end{tikzpicture}\\[-2pt]
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(f2b.south east)}, y={(f2b.north west)}]
      % Mask any embedded panel letter and place TeX label
      \node[font=\bfseries, anchor=north west, fill=white, draw=white, inner sep=2pt, rounded corners=0.5pt] at (0.012, 0.988) {(b)};
    \end{scope}
  \end{tikzpicture}
  \vspace{-3pt}
