...
\begin{figure}[t]
  ...
  \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] (img3a) at (0,0)
      ...
      {\includegraphics[width=0.8\linewidth]{figures/figure03_a_events.pdf}};
  ...
  \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] (img3b) at (0,0)
      ...
      {\includegraphics[width=0.8\linewidth]{figures/figure03_b_variance.pdf}};
  ...
  \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] (img3c) at (0,0)
      ...
      {\includegraphics[width=0.8\linewidth]{figures/figure03_c_bin50ms.pdf}};
