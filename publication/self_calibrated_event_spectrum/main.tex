...
\begin{figure}[t]
  ...
  \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] (img3a) at (0,0)
      % {\includegraphics[width=\linewidth]{../../publication_code/figures/multiwindow_events_blank.pdf}};
  ...
  \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] (img3b) at (0,0)
      % {\includegraphics[width=\linewidth]{../../publication_code/figures/multiwindow_variance_blank.pdf}};
  ...
  \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] (img3c) at (0,0)
      % {\includegraphics[width=\linewidth]{../../publication_code/figures/multiwindow_bin50ms_sanqin.pdf}};
...
\end{equation}
reveals the scanning period, while the auto-convolution between $a[n]$ and its time-reversed sequence $a_{\mathrm{rev}}[n] = a[N{-}1{-}n]$,
\begin{equation}
